...
class UpdateRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'actual_start_date.date' => 'Tanggal mulai tidak valid.',
            
            'actual_end_date.date' => 'Tanggal selesai tidak valid.',
            'actual_end_date.after_or_equal' => 'Tanggal selesai tidak boleh sebelum tanggal mulai.',
        ];
    }
}
