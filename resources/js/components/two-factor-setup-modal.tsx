    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description: 'Autentikasi dua faktor kini telah aktif. Pindai kode QR atau masukkan kunci pengaturan ke aplikasi autentikator Anda.',
                buttonText: 'Tutup',
            };
        }
        ...
        return {
            ...
            description: 'Untuk menyelesaikan pengaktifan autentikasi dua faktor, pindai kode QR atau masukkan kunci pengaturan ke aplikasi autentikator Anda',
            buttonText: 'Lanjutkan',
        };
