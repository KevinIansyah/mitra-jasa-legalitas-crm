...
export interface ServicePackageFeatureBatchFormData {
    features: Omit<ServicePackageFeatureFormData, 'service_package_id'>[];
}

export interface ServiceFaqBatchFormData {
    faqs: Omit<ServiceFaqFormData, 'service_id'>[];
}

export interface ServiceLegalBasisBatchFormData {
    legal_bases: Omit<ServiceLegalBasisFormData, 'service_id'>[];
}

export interface ServiceRequirementCategoryBatchFormData {
    categories: (Omit<ServiceRequirementCategoryFormData, 'service_id'> & {
        requirements?: Omit<ServiceRequirementFormData, 'service_requirement_category_id'>[];
    })[];
}

export interface ServiceRequirementBatchFormData {
    requirements: Omit<ServiceRequirementFormData, 'service_requirement_category_id'>[];
}

export interface ServiceProcessStepBatchFormData {
    process_steps: Omit<ServiceProcessStepFormData, 'service_id'>[];
}
...
export interface ServiceFilterParams {
    ...
    is_featured?: boolean;
    is_popular?: boolean;
    sort_by?: 'name' | 'created_at' | 'published_at' | 'sort_order';
    sort_order?: 'asc' | 'desc';
    page?: number;
    per_page?: number;
}

export interface ServiceFaqFilterParams {
    service_id?: number;
    status?: ServiceStatus;
    search?: string;
}

export interface ServiceLegalBasisFilterParams {
    service_id?: number;
    document_type?: string;
    status?: ServiceStatus;
    search?: string;
...
export interface ServiceRequirementFilterParams {
    service_id?: number;
    category_id?: number;
    is_required?: boolean;
    status?: ServiceStatus;
...
export interface ServiceProcessStepFilterParams {
    service_id?: number;
    status?: ServiceStatus;
    search?: string;
}
