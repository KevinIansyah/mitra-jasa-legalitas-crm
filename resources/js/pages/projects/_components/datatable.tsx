            ...
            <div className="flex flex-col gap-4 pb-4">
                                ...
                                <div className="space-y-4 px-4">
                                    ...
                                    <Field>
                                        ...
                                        <SearchSelect
                                            ...
                                            onChange={(val) => updateFilter('customer_id', val)}
                                            valueKey="id"
                                            labelKey="name"
                                    ...
                                    <Field>
                                        ...
                                        <SearchSelect
                                            ...
                                            onChange={(val) => updateFilter('service_id', val)}
                                            valueKey="id"
                                            labelKey="name"
                ...
                {activeFiltersCount > 0 && (
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {filters.customer_id && (
                            <Badge variant="secondary" className="gap-2">
                                Pelanggan: {selectedCustomers?.name}
                                <Button variant="ghost" size="sm" className="h-6 w-6 text-xs" onClick={() => updateFilter('customer_id', undefined)}>
                                    <X className="size-3" />
                                </Button>
                            </Badge>
                        )}
                        {filters.company_id && (
                            <Badge variant="secondary" className="gap-2">
                                Perusahaan: {selectedCompanies?.name}
                                <Button variant="ghost" size="sm" className="h-6 w-6 text-xs" onClick={() => updateFilter('company_id', undefined)}>
                                    <X className="size-3" />
                                </Button>
                            </Badge>
                        )}
