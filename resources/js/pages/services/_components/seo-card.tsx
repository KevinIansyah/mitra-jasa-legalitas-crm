...
export const defaultSeo = (): LocalServiceSeo => ({
    meta_title: '',
    meta_description: '',
    canonical_url: '',
    focus_keyword: '',
...
export function SeoCard({ seo, onChange, errors = {}, schemaMarkup }: SeoCardProps) {
    ...
    const update = (patch: Partial<LocalServiceSeo>) => onChange({ ...seo, ...patch });
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    {(['service', 'breadcrumb', 'faq', 'howto'] as const).map((type) => (
