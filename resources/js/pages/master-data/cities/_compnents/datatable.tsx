...
export function DataTable({ data, pageIndex, setPageIndex, totalPages, totalItems, perPage, provinces, initialFilters = {} }: DataTableProps) {
    ...
    const { searchValue, clearSearch, handleSearchChange, filters, updateFilter, goToPage, changePageSize, canPreviousPage, canNextPage, resetFilters, activeFiltersCount } =
        useDataTableWithFilters({
            ...
            perPage,
            initialFilters,
            onlyFields: ['cities', 'filters'],
            routeUrl: citiesRoute.index().url,
        });
                ...
                <div className="flex flex-col items-center justify-between gap-2 md:flex-row">
                    <div className="flex w-full flex-1 items-center gap-2 md:w-auto">
                        ...
                        <InputGroup className="max-w-sm">
                            <InputGroupInput placeholder="Cari nama atau provinsi kota..." value={searchValue} onChange={handleSearchChange} />
                            <InputGroupAddon>
                                <Search />
                            </InputGroupAddon>
                        </InputGroup>
                        ...
                        <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                            ...
                            <SheetContent>
                                <SheetHeader>
                                    ...
                                    <SheetDescription>Atur filter untuk menyaring data kota</SheetDescription>
                                </SheetHeader>
                                ...
                                <div className="space-y-4 px-4">
                                    ...
                                    {provinces.length > 0 && (
                                        <Field>
                                            ...
                                            <Select value={filters.province || ''} onValueChange={(value) => updateFilter('province', value || undefined)}>
                                                <SelectTrigger className="w-full">
                    ...
                    <div className="flex w-full gap-2 md:w-auto">
                        ...
                        {/* Add City */}
                        <HasPermission permission="create-master-cities">
                            <DrawerAdd />
                        </HasPermission>
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {filters.province && (
                            <Badge variant="secondary" className="gap-2">
                                ...
                                <Button variant="ghost" size="sm" className="h-6 w-6 text-xs" onClick={() => updateFilter('province', undefined)}>
                                    <X className="size-3" />
                                </Button>
                            </Badge>
                        )}
