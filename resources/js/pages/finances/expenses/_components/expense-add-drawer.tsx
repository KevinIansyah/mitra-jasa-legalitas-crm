                            ...
                            {fromProject && (
                                <div className="col-span-2 flex items-center gap-4 rounded-lg border border-primary bg-transparent p-4 dark:bg-input/30">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Pengeluaran ini akan muncul sebagai saran item pada invoice additional</p>
                                    </div>
                                </div>
                            )}
                            {errors.is_billable && <FieldError>{errors.is_billable}</FieldError>}
                        </div>
