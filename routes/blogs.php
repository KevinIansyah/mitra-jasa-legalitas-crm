...
use App\Http\Controllers\Blogs\BlogSubscriberController;
...
Route::middleware(['auth', 'verified', 'restrict_user'])->group(function () {
    ...
    Route::prefix('blogs')->name('blogs.')->group(function () {
        ...
        /*
          ...
          |--------------------------------------------------------------------------
          | GET    /blogs/subscribers              -> List subscribers
          | DELETE /blogs/subscribers/{subscriber} -> Remove subscriber
          |--------------------------------------------------------------------------
          */

        Route::prefix('subscribers')->name('subscribers.')->group(function () {
            Route::get('/', [BlogSubscriberController::class, 'index'])
                ->middleware('permission:view-blog-subscribers')
                ->name('index');

            Route::delete('/{subscriber}', [BlogSubscriberController::class, 'destroy'])
                ->middleware('permission:delete-blog-subscribers')
                ->name('destroy');
        });
